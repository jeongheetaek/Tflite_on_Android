...
public class Dream365 extends Fragment {
    private ProgressBar progressBar;

    @Nullable
    @Override    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_dream365, container, false);
...
//                            continue;
                ...
                infoAdapter.setOnItemClickListener(new InfoAdapter.OnItemClickListener<Info>() {
                    ...
                    public void onItemClick(Info item, int position) {
                        Intent i = new Intent(getContext(), Dream365DetailAcvtivity.class);
