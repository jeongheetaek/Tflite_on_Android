...
public class OutletPolicyDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView category = findViewById(R.id.detail_category3);
        category.setText(titles[0].trim());
        TextView title = findViewById(R.id.detail_title3);
        title.setText(titles[1].trim());

        TextView date = findViewById(R.id.detail_date3);
        date.setText(info.getDate());

        TextView writer = findViewById(R.id.detail_writer3);
        writer.setText(info.getWriter());

        TextView content = findViewById(R.id.detail_content3);
        content.setText(info.getContent());

        List<HashMap<String, String>> files = info.getFiles();

        RecyclerView recyclerView = findViewById(R.id.detail_recycler_view3);
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter<OutletPolicyDetailActivity.File>() {
            @NonNull
            @Override
