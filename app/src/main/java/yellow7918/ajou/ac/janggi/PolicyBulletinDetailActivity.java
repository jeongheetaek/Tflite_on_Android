...
public class PolicyBulletinDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_policy_bulletin);
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter<PolicyBulletinDetailActivity.File>() {
            @NonNull
            @Override
