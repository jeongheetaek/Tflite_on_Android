...
public class Dream365DetailAcvtivity extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_dream365);
        ...
        TextView category = findViewById(R.id.detail_category1);
        category.setText(titles[0].trim());
        TextView title = findViewById(R.id.detail_title1);
        title.setText(titles[1].trim());

        TextView date = findViewById(R.id.detail_date1);
        date.setText(info.getDate());

        TextView writer = findViewById(R.id.detail_writer1);
        ...
        RecyclerView recyclerView = findViewById(R.id.detail_recycler_view1);
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter<Dream365DetailAcvtivity.File>() {
            @NonNull
            @Override
