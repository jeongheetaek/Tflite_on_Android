...
public class Classifi_MainActivity5 extends AppCompatActivity {
    TextToSpeech tts;
    EditText inputtext;
    Button button;
    ...
    private static final String MODEL_PATH = "conv5.tflite";
    private static final String LABEL_PATH = "conv_labels5.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraView.addCameraKitListener(new CameraKitEventListener() {
            ...
            public void onImage(CameraKitImage cameraKitImage) {
                ...
                mp.pause();
                if(text.contains("bae")){
                    text = "베지밀두유";
                }else if(text.contains("cars")){
                    text = "카스테라";
                }else if(text.contains("coocu")){
                    text = "쿠크다스커피";
                }else if(text.contains("coowhite")){
                    text = "쿠크다스화이트";
                }else if(text.contains("doyou")){
                    text = "매일두유";
                }else if(text.contains("ggo")){
                    text = "꼬북칩";
                }else if(text.contains("ya")){
                    text = "야쿠르트";
                }else if(text.contains("young")){
                    text = "영양";
                }
