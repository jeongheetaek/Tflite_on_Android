...
public class SignUpActivity3 extends AppCompatActivity {
    ...
    private static String[] pickInfo(String original) {
        ...
        */
        ...
        /*
        if(original.contains("1234")) {
            target_num[1]=original.indexOf("1234"); //3
            if(target_num[1] != 0) {
                result[1] = original.substring(target_num[1] + 3, target_num[2]-1);
                result[1] = result[1].replace("null", "");
                Log.d("Log", result[1]);
            }
            else result[1] = "내용을 찾지 못했습니다.";
        }
        if(original.contains("자명")) {
            target_num[3]=original.indexOf("자명:"); //3이라서 아래 3
            if(target_num[0] != 0) {
                result[2] = original.substring(target_num[2] + 3, target_num[2]-1);
                result[2] = result[2].replace("null", "");
                Log.d("Log", result[2]);
            }
            else result[2] = "내용을 찾지 못했습니다.";
